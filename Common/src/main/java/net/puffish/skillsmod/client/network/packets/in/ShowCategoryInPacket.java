...
public class ShowCategoryInPacket implements InPacket {
	...
	public static ClientExchangeColorsConfig readExchangeColors(FriendlyByteBuf buf) {
		var cost = readExchangeCostColors(buf);

		return new ClientExchangeColorsConfig(cost);
	}

	public static ClientExchangeCostColorsConfig readExchangeCostColors(FriendlyByteBuf buf) {
