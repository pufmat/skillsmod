...
public record ShowCategoryOutPacket(CategoryConfig category, CategoryData categoryData) implements OutPacket {
	...
	public static void write(FriendlyByteBuf buf, ExchangeColorsConfig exchangeColors) {
		write(buf, exchangeColors.cost());
	}

	public static void write(FriendlyByteBuf buf, ExchangeCostColorsConfig exchangeCostColors) {
