...
public class SkillsCriteria {
	...
	public static class SkillUnlockedCriterion extends AbstractCriterion<SkillUnlockedCriterion.Conditions> {
		...
		public Conditions conditionsFromJson(JsonObject json, EntityPredicate.Extended extended, AdvancementEntityPredicateDeserializer deserializer) {
			var categoryId = new Identifier(JsonHelper.getString(json, "category"));
			var skillId = JsonHelper.getString(json, "skill");
			return new Conditions(extended, categoryId, skillId);
		}
		...
		public static class Conditions extends AbstractCriterionConditions {
			...
			public Conditions(EntityPredicate.Extended extended, Identifier categoryId, String skillId) {
				super(SkillUnlockedCriterion.ID, extended);
