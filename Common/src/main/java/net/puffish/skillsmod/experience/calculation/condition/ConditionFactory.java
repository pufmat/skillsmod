...
public interface ConditionFactory<T> extends BiFunction<Result<JsonElementWrapper, Error>, ConfigContext, Result<? extends Condition<T>, Error>> {
	...
	static <T> ConditionFactory<T> withoutData(Function<ConfigContext, Result<? extends Condition<T>, Error>> factory) {
		return (maybeData, context) -> factory.apply(context);
	}

	static <T> ConditionFactory<T> withData(BiFunction<JsonElementWrapper, ConfigContext, Result<? extends Condition<T>, Error>> factory) {
